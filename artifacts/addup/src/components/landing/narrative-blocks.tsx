...
function VisualPreventBadData() {
  return (
    <div className="relative w-full aspect-[4/3] bg-card border border-border/40 shadow-[0_15px_50px_-15px_rgba(0,0,0,0.1)] overflow-hidden p-6 sm:p-8 flex flex-col justify-center">
      ...
      <div className="space-y-4 relative z-10">
        <motion.div
          ...
          className="bg-background border border-red-500/20 p-3 shadow-sm flex items-center gap-3 relative"
        >
          <div className="h-8 w-8 bg-red-500/10 flex items-center justify-center text-red-500 text-xs font-bold">ERR</div>
          <div className="flex-1 space-y-1.5">
            <div className="h-3 w-24 bg-foreground/10"></div>
            <div className="h-2 w-16 bg-red-500/20"></div>
          </div>
        ...
        <motion.div
          ...
          className="bg-background border border-emerald-500/20 p-3 shadow-sm flex items-center gap-3"
        >
          <div className="h-8 w-8 bg-emerald-500/10 flex items-center justify-center text-emerald-600 text-xs font-bold">OK</div>
          <div className="flex-1 space-y-1.5">
            <div className="h-3 w-32 bg-foreground/20"></div>
            <div className="h-2 w-20 bg-muted-foreground/20"></div>
          </div>
...
function VisualMatchIntelligently() {
  return (
    <div className="relative w-full aspect-[4/3] bg-card border border-border/40 shadow-[0_15px_50px_-15px_rgba(0,0,0,0.1)] overflow-hidden p-6 sm:p-8 flex items-center justify-center">
      ...
      <div className="relative w-full max-w-[280px]">
        <div className="bg-background border border-border p-3 shadow-sm mb-16 relative z-10 w-[70%]">
        ...
        <div className="absolute top-12 right-0 bg-blue-500/10 text-blue-600 dark:text-blue-400 text-xs font-bold px-2 py-0.5 border border-blue-500/20 z-20">94% match</div>
        <div className="absolute top-16 -left-8 bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 text-xs font-bold px-2 py-0.5 border border-indigo-500/20 z-20">88% match</div>

        <div className="flex gap-4 justify-end relative z-10">
          <div className="bg-background border border-border p-3 shadow-sm w-1/2">
...
function VisualResolve() {
  return (
    <div className="relative w-full aspect-[4/3] bg-card border border-border/40 shadow-[0_15px_50px_-15px_rgba(0,0,0,0.1)] overflow-hidden p-6 sm:p-8 flex flex-col justify-center items-center">
      ...
      <div className="relative w-full max-w-[280px]">
        <motion.div
          ...
          className="relative bg-background border border-border shadow-md overflow-hidden z-10"
        >
          <div className="p-4 border-b border-border/50">
            <div className="flex items-center justify-between mb-3">
              <span className="text-[10px] font-bold uppercase tracking-wider text-amber-600 bg-amber-500/10 px-2 py-0.5">Needs review</span>
  ...
  return (
    <div className="relative w-full aspect-[4/3] bg-card border border-border/40 shadow-[0_15px_50px_-15px_rgba(0,0,0,0.1)] overflow-hidden p-6 sm:p-8 flex flex-col justify-center">
      ...
      <motion.div
        ...
        className="bg-background border border-border shadow-sm p-5 relative z-10"
      >
        ...
        <div className="flex flex-wrap gap-2">
          <span className="inline-flex items-center px-2 py-1 text-[10px] font-medium bg-muted border border-border/50">Amount: Exact</span>
          <span className="inline-flex items-center px-2 py-1 text-[10px] font-medium bg-muted border border-border/50">Date: ±1 day</span>
          <span className="inline-flex items-center px-2 py-1 text-[10px] font-medium bg-muted border border-border/50">Ref: 0.89 sim</span>
        </div>
      </motion.div>
    </div>
  );
    ...
    <section className="py-16 sm:py-24 bg-background">
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        ...
        <div className="flex justify-center mb-10 sm:mb-12 -mx-6 px-6 overflow-x-auto scrollbar-none">
          <div className="inline-flex items-center gap-0 border border-border/60 shrink-0">
            {blocks.map((b, i) => (
              <button
                key={b.id}
                onClick={() => setActive(i)}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-14 items-center min-h-[360px]">
          <AnimatePresence mode="wait">
            ...
            >
              <div className="inline-flex items-center border border-border/60 bg-muted/40 px-2.5 py-0.5 text-[11px] font-medium tracking-wide uppercase text-muted-foreground mb-4">
                {block.eyebrow}
              </div>
